<?php
include "header.php";
$newNotebook = mysqli_query($conn, "SELECT * FROM product WHERE category_id = '1' Order By id DESC;");

    ?>
<section class="category" style="display:flex">
    <?php include "left_note_book.php"?>
    <div class="container" style="padding-top:6rem">
        <div class="textProductNew">
            <h2>Vở các loại <i class='bx bx-edit-alt bx-tada bx-flip-vertical'
